...
const RowThree = () => {
  ...
  return (
    <>
      <BoxStyle bgcolor="#fff" gridArea="g">
        <BoxHeader
      ...
      <BoxStyle bgcolor="#fff" gridArea="h">
        <BoxHeader
          title="Recent Orders"
      ...
      <BoxStyle bgcolor="#fff" gridArea="i">
      ...
      <BoxStyle bgcolor="#fff" gridArea="j">
        <BoxHeader
        ...
        <Typography margin="0 1rem" variant="h6">
          ...
          odio reprehenderit. Perferendis, laborum, non natus, quisquam ullam
          sapiente quod maxime eaque culpa libero eos mollitia optio. Qui,
